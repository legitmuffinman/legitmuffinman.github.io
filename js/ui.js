...
function toggleLoading(isLoading) {
  ...
  if(isLoading) {
    searchForm.firstChild.className = "fas fa-hourglass-half"
    searchForm.lastChild.innerText = " Loading..."
    searchForm.disabled = true;
  } else {
    searchForm.firstChild.className = "fas fa-search"
    searchForm.lastChild.innerText = " Search"
